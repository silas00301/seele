        ...
        seele-lock =
          ...
          pkgs.stdenvNoCC.mkDerivation {
            ...
            installPhase = ''
              ...
              install -m644 ${./_seele-lock/shell.qml} "$out/share/seele-lock/shell.qml"
              node ${./_seele-shell/grain.js} "$out/share/seele-lock/grain.png"
              substitute ${./_seele-lock/lock.sh} "$out/libexec/seele-lock" \
