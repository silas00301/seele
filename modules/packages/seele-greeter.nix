        ...
        seele-greeter =
          ...
          pkgs.stdenvNoCC.mkDerivation {
            ...
            installPhase = ''
              ...
              substitute ${./_seele-greeter/shell.qml} "$out/share/seele-greeter/shell.qml" \
                --replace-fail '@SYSTEMCTL@' '${pkgs.systemd}/bin/systemctl'
              node ${./_seele-shell/grain.js} "$out/share/seele-greeter/grain.png"
              substitute ${./_seele-greeter/greeter.sh} "$out/bin/seele-greeter" \
