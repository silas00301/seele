    ...
    in
    {
      ...
      wayland.windowManager.hyprland = {
        ...
        extraConfig = ''
          ...
          hl.layer_rule({
            match = {
              namespace = "^seele-shell-(bar|osd|agents|tray-menu|application|calendar|clock|focus|github|home-assistant|control-center|media|audio|network|vpn|bluetooth|airpods|battery|notifications|camera|session|polkit)$",
            },
            blur = true,
